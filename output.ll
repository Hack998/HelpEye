...
entry:
  ...
  %".3" = call i32 (i8*, ...) @"printf"(i8* %".2", i8 30)
  %".4" = bitcast [7 x i8]* @"rrt" to i8*
  %".5" = call i32 (i8*, ...) @"printf"(i8* %".4", i8 30)
  ...
  %".11" = call i32 (i8*, ...) @"printf"(i8* %".10", i8 27)
  %".12" = bitcast [7 x i8]* @"rrrrrrt" to i8*
  %".13" = call i32 (i8*, ...) @"printf"(i8* %".12", i8 114)
  %".14" = bitcast [7 x i8]* @"rrrrrrrt" to i8*
  %".15" = call i32 (i8*, ...) @"printf"(i8* %".14", i8 91)
  ret void
}
...
@"rrrrrrt" = internal constant [7 x i8] c"Safe \0a\00"
@"rrrrrrrt" = internal constant [7 x i8] c"Safe \0a\00"